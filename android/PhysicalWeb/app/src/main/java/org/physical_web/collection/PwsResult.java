...
public class PwsResult {
  ...
  public PwsResult(
      ...
      String groupId, JSONObject extraData) throws JSONException {
   ...
   * @param siteUrl The site URL, as reported by the PWS.
   */
  public PwsResult(String requestUrl, String siteUrl) throws JSONException {
  ...
  public static class Builder {
     ...
     */
    public PwsResult build() throws JSONException {
