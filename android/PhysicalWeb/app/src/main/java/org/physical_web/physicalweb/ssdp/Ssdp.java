...
public class Ssdp implements Runnable {
    ...
    public synchronized boolean start(Integer timeout) throws IOException{
        if (mThread == null){
            mDatagramSocket = new DatagramSocket(null); // create a DatagramSocket without binding to any address
            mDatagramSocket.setReuseAddress(true);
            mDatagramSocket.bind(null); // bind to any free port
